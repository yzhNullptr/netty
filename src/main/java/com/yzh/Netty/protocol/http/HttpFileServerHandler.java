...
import static com.yzh.Netty.protocol.http.HttpFileServer.DEFAULT_URL;
...
/**
 * @author: yzh
 * @date: 2023-10-23 08:50:30
 * @Description: 写了一堆 完全看不懂
 *
 */
public class HttpFileServerHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
    ...
    protected void messageReceived(ChannelHandlerContext ctx, FullHttpRequest request) throws Exception {
        ...
        setContextTypeHeader(response, file);
    ...
    private void sendListing(ChannelHandlerContext ctx, File file) {
        FullHttpMessage response = new DefaultFullHttpResponse(HTTP_1_1, OK);
    ...
    private void setContextTypeHeader(HttpResponse response, File file) {
