...
/**
 * @author: yzh
 * @date: 2023-10-24 15:13:01
 * @Description: 请求消息编码器
 */
public class HttpXmlRequestEncoder extends AbstractHttpXmlEncoder<HttpXmlRequest>{
    @Override
    protected void encode(ChannelHandlerContext ctx, HttpXmlRequest msg, List<Object> list) throws UnknownHostException {
        ByteBuf body= null;
        try {
            body = super.encode0(ctx,msg.getBody());
        } catch (Exception e) {
            e.printStackTrace();
        }
